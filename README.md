...
```javascript
import uncapitalizeKeys from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-uncapitalize-keys@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-uncapitalize-keys/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-uncapitalize-keys/actions/workflows/test.yml?query=branch:v0.1.0
