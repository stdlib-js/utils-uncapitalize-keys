...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/utils-uncapitalize-keys/tags). For example,

```javascript
uncapitalizeKeys = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-uncapitalize-keys@v0.1.0-umd/browser.js' )
```
